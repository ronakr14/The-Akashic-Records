---
id: ghvf8vtr9j4o4wea445dg7h
title: Frameworks
desc: ''
updated: 1752423900530
created: 1752423899202
---
...
| [oneAPI Data Analytics Library](https://github.com/oneapi-src/oneDAL) | High-performance analytics library developed by Intel for batch, online, and distributed data processing.|General Purpose|
...
| **Tool** | **Description** | **Category** |
|----------|---------------|-------------|
|[OpenCVDotNet](https://code.google.com/archive/p/opencvdotnet)|A wrapper for the OpenCV project to be used with .NET applications.|Computer Vision|
|[Emgu CV](http://www.emgu.com/wiki/index.php/Main_Page)|Cross platform wrapper of OpenCV which can be compiled in Mono to be run on Windows, Linus, Mac OS X, iOS, and Android.|Computer Vision|
|[AForge.NET](http://www.aforgenet.com/framework/)|Open source C# framework for developers and researchers in the fields of Computer Vision and Artificial Intelligence. Development has now shifted to GitHub.|Computer Vision|
|[Accord.NET](http://accord-framework.net)|Together with AForge.NET, this library can provide image processing and computer vision algorithms to Windows, Windows RT and Windows Phone. Some components are also available for Java and Android.|Computer Vision|
|[Stanford.NLP for .NET](https://github.com/sergey-tihon/Stanford.NLP.NET/)|A full port of Stanford NLP packages to .NET and also available precompiled as a NuGet package.|NLP|
|[Accord-Framework](http://accord-framework.net/)|The Accord.NET Framework is a complete framework for building machine learning, computer vision, computer audition, signal processing and statistical applications.|General Purpose|
|[Accord.MachineLearning](https://www.nuget.org/packages/Accord.MachineLearning/)|Support Vector Machines, Decision Trees, Naive Bayesian models, K-means, Gaussian Mixture models and general algorithms such as Ransac, Cross-validation and Grid-Search for machine-learning applications. This package is part of the Accord.NET Framework.|General Purpose|
...
|[SimpleCV](http://simplecv.org/)|An open source computer vision framework that gives access to several high-powered computer vision libraries, such as OpenCV. Written on Python and runs on Mac, Windows, and Ubuntu Linux.|Computer Vision|
...
| **Library/Tool**| **Description**|**Category**|
|-------------------------------|---------------------------------------|-------------------------------|
| [ScalaNLP](http://www.scalanlp.org/)| A suite of machine learning and numerical computing libraries for Scala.|NLP|
| [Breeze](https://github.com/scalanlp/breeze)| Numerical processing library for Scala.|NLP|
| [FACTORIE](https://github.com/factorie/factorie)| Toolkit for deployable probabilistic modeling with a succinct language for creating relational factor graphs.|NLP|
| [Montague](https://github.com/Workday/upshot-montague)| Semantic parsing library for Scala with an easy-to-use DSL.|NLP|
| [Spark NLP](https://github.com/JohnSnowLabs/spark-nlp)| NLP library built on top of Apache Spark ML for distributed and scalable processing.|NLP|
| [NDScala](https://github.com/SciScala/NDScala)| N-dimensional arrays in Scala 3 with compile-time type-checking, labels, and numeric types.|Data Analysis & Visualization|
| [MLlib in Apache Spark](https://spark.apache.org/docs/latest/mllib-guide.html) | Distributed machine learning library in Spark.|Data Analysis & Visualization|
| [Hydrosphere Mist](https://github.com/Hydrospheredata/mist)| Service for deploying Spark MLlib models as web services in real-time, batch, or reactive modes.|Data Analysis & Visualization|
| [Scalding](https://github.com/twitter/scalding)| Scala API for Cascading.|Data Analysis & Visualization|
| [Summing Bird](https://github.com/twitter/summingbird)| Streaming MapReduce with Scalding and Storm.|Data Analysis & Visualization|
| [Algebird](https://github.com/twitter/algebird)| Abstract Algebra library for Scala.|Data Analysis & Visualization|
| [PredictionIO](https://github.com/apache/predictionio)| Machine learning server for developers and data engineers.|Data Analysis & Visualization|
| [BIDMat](https://github.com/BIDData/BIDMat)| CPU and GPU-accelerated matrix library for large-scale exploratory data analysis.|Data Analysis & Visualization|
| [Flink](https://flink.apache.org/)| Open-source platform for distributed stream and batch data processing.|Data Analysis & Visualization|
| [Spark Notebook](http://spark-notebook.io)| Interactive and reactive data science platform using Scala and Spark.|Data Analysis & Visualization|
| [Microsoft ML for Apache Spark](https://github.com/Azure/mmlspark)| Distributed machine learning framework for Apache Spark.|General Purpose|
| [ONNX-Scala](https://github.com/EmergentOrder/onnx-scala)| ONNX API and backend for type-safe, functional deep learning in Scala.|General Purpose|
| [DeepLearning.scala](https://deeplearning.thoughtworks.school/)| Create statically-typed dynamic neural networks from functional programming constructs.|General Purpose|
| [Conjecture](https://github.com/etsy/Conjecture)| Scalable machine learning library in Scalding.|General Purpose|
| [brushfire](https://github.com/stripe/brushfire)| Distributed decision tree ensemble learning in Scala.|General Purpose|
| [adam](https://github.com/bigdatagenomics/adam)| Genomics  engine built using Apache Spark.|General Purpose|
| [bioscala](https://github.com/bioscala/bioscala)| Bioinformatics tools for Scala.|General Purpose|
| [BIDMach](https://github.com/BIDData/BIDMach)| CPU and GPU-accelerated machine learning library.|General Purpose|
| [Figaro](https://github.com/p2t2/figaro)| Scala library for constructing probabilistic models.|General Purpose|
| [H2O Sparkling Water](https://github.com/h2oai/sparkling-water)| H2O and Spark interoperability library.|General Purpose|
| [FlinkML in Apache Flink](https://ci.apache.org/projects/flink/flink-docs-master/dev/libs/ml/index.html) | Distributed machine learning library in Flink.|General Purpose|
| [DynaML](https://github.com/transcendent-ai-labs/DynaML)| Scala library and REPL for machine learning research.|General Purpose|
| [Saul](https://github.com/CogComp/saul)| Declarative learning-based programming library.|General Purpose|
| [SwiftLearner](https://github.com/valdanylchuk/swiftlearner/)| Simplified machine learning algorithms for educational purposes.|General Purpose|
| [Smile](https://haifengl.github.io/)| Statistical Machine Intelligence and Learning Engine.|General Purpose|
| [doddle-model](https://github.com/picnicml/doddle-model)| In-memory ML library built on top of Breeze, with a scikit-learn-like API.|General Purpose|
| [TensorFlow Scala](https://github.com/eaplatanios/tensorflow_scala)| Strongly-typed Scala API for TensorFlow.|General Purpose|
...
|-------------------------------|---------------------------------------|-------------------------------|
| [Awesome Keras](https://github.com/markusschanta/awesome-keras)| A curated list of awesome Keras projects, libraries, and resources.|General Purpose|
| [Awesome TensorFlow](https://github.com/jtoy/awesome-tensorflow)| Comprehensive list of TensorFlow projects, tools, and resources.|General Purpose|
| [Golden TensorFlow](https://golden.com/wiki/TensorFlow)| A centralized page on TensorFlow, including academic papers and links to related topics.|General Purpose|
...
| **Tool**| **Description**|**Category**|
|--------------------------|------------------------------------------|--------------------------|
| [layer](https://github.com/cloudkj/layer)| Command-line tool for neural network inference.|Neural Network|
| [Synthical](https://synthical.com)| AI-powered research environment for article recommendations, simplifying papers, and collaborative sharing.|Misc|
| [Humanloop](https://humanloop.com)| Platform for prompt experimentation, fine-tuning, cost optimization, and feedback collection.|Misc|
| [Qdrant](https://qdrant.tech)| Open-source vector similarity search engine with extended filtering support (written in Rust).|Misc|
| [milvus](https://milvus.io)| Open-source vector database for AI applications, written in Go and C++.|Misc|
| [Weaviate](https://www.semi.technology/developers/weaviate/current/)| Open-source vector search engine for ML-driven queries and custom model integration.|Misc|
| [txtai](https://github.com/neuml/txtai)| Build semantic search applications and workflows.|Misc|
| [MLReef](https://about.mlreef.com/)| End-to-end development platform leveraging git for structured ML collaboration.|Misc|
| [Pinecone](https://www.pinecone.io/)| Vector database for real-time, scalable embedding and similarity search.|Misc|
| [CatalyzeX](https://chrome.google.com/webstore/detail/code-finder-for-research/aikkeehnlfpamidigaffhfmgbkdeheil) | Browser extension for finding code implementations of ML papers.|Misc|
| [ML Workspace](https://github.com/ml-tooling/ml-workspace)| Web-based IDE preloaded with libraries like TensorFlow, PyTorch, and Jupyter.|Misc|
| [Notebooks](https://github.com/rlan/notebooks)| Starter kit for Jupyter notebooks with Docker support for multiple ML frameworks.|Misc|
| [DVC](https://github.com/iterative/dvc)| Version control for ML projects, enabling reproducibility and pipeline management.|Misc|
| [DVClive](https://github.com/iterative/dvclive)| Python library for experiment metrics logging.|Misc|
| [VDP](https://github.com/instill-ai/vdp)| Open-source ETL pipeline for transforming visual data into structured insights.|Misc|
| [Kedro](https://github.com/quantumblacklabs/kedro/)| Framework for data pipeline workflows and production-ready ML models.|Misc|
| [guild.ai](https://guild.ai/)| Cross-platform tool for experiment tracking, optimization, and visualizations.|Misc|
| [Sacred](https://github.com/IDSIA/sacred)| Organize, log, and reproduce experiments with Python.|Misc|
| [Comet](https://www.comet.com/)| Experiment tracking, hyperparameter tuning, and artifact management for ML.|Misc|
| [MLFlow](https://mlflow.org/)| Framework-agnostic platform to manage the ML lifecycle, including deployment.|Misc|
| [Weights & Biases](https://www.wandb.com/)| Experiment tracking, visualization, and collaboration for ML projects.|Misc|
| [Chaos Genius](https://github.com/chaos-genius/chaos_genius/)| Analytics engine for anomaly detection and root cause analysis.|Misc|
| [Flyte](https://flyte.org/)| Scalable workflow orchestration for ML and data processing.|Misc|
| [MLEM](https://github.com/iterative/mlem)| GitOps-based versioning and deployment of ML models.|Misc|
| [DockerDL](https://github.com/matifali/dockerdl)| Ready-to-use deep learning Docker images.|Misc|
| [Aqueduct](https://github.com/aqueducthq/aqueduct)| Define, run, and manage AI tasks on any cloud infrastructure.|Misc|
| [Ambrosia](https://github.com/reactorsh/ambrosia)| Tool for cleaning datasets using LLMs.|Misc|

---

## Books

Expand your understanding of Machine Learning and Artificial Intelligence with these insightful books:

| **Book Title**| **Description**|
|-------------------------------|---------------------------------|
| [Distributed Machine Learning Patterns](https://github.com/terrytangyuan/distributed-ml-patterns) | Learn how to scale machine learning models from laptops to large distributed clusters. This book covers essential patterns and technologies like TensorFlow, Kubernetes, and Kubeflow with hands-on projects.    |
| [Grokking Machine Learning](https://www.manning.com/books/grokking-machine-learning)             | A beginner-friendly guide that teaches how to apply machine learning to projects using standard Python and high school-level math.                                                                              |
| [Machine Learning Bookcamp](https://www.manning.com/books/machine-learning-bookcamp)             | Master the fundamentals of machine learning through real-world projects, tailored to solidify your understanding of essential concepts.                                                                          |
| [Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow](https://www.amazon.com/Hands-Machine-Learning-Scikit-Learn-TensorFlow/dp/1098125975) | This bestselling book uses practical examples and Python frameworks to teach you how to build intelligent systems with minimal theory and hands-on experience.                                                   |