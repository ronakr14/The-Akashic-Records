...
---
# AI Summary
Neon is an open-source serverless PostgreSQL platform that separates stateless compute from durable storage to enable autoscaling, scale-to-zero, instant branching, and fast recovery. The note analyzes its distributed architecture, including compute nodes, pageserver, safekeepers, proxy, and control plane, along with WAL-based durability, branching, replication, storage management, engineering trade-offs, enterprise evaluation, interview questions, and applications in cloud-native platforms, data engineering, AI systems, and developer productivity workflows
