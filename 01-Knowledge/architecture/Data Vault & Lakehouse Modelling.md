...
---
# AI Summary
Comprehensive guide to modern enterprise data modeling, explaining how Data Vault and Lakehouse architectures complement rather than replace traditional dimensional modeling. Covers Data Vault fundamentals (Hubs, Links, Satellites, Business Vault), auditability, historical tracking, implementation trade-offs, Medallion Architecture, Lakehouse modeling patterns, decision matrices, interview questions, DDL examples, and recommended end-to-end enterprise architectures for regulated industries such as healthcare and finance. 
...
- [[Data Modelling]] — dimensional modelling this complements
- [[ELT (Extract, Load, Transform)]] — medallion / Bronze-Silver-Gold pipeline
- [[Data Mesh]] — organizational layer above the modelling
- [[_Architecture MOC]] — domain index
