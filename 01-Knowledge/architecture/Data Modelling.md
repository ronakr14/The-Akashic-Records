...
---
# AI Summary
Comprehensive guide to data modeling for data engineers, covering conceptual, logical, and physical models; entities, attributes, relationships, keys, and normalization; OLTP versus OLAP design; dimensional modeling with Star Schema and Snowflake Schema; Slowly Changing Dimensions, Data Vault, and Lakehouse modeling. Includes practical examples, common design mistakes, senior engineering perspectives, and a structured learning roadmap from beginner to advanced data modeling concepts. 
...
- [[Data Modelling Checklist]] — step-by-step methodology for the same task
- [[Database Design]] — physical-model concerns: keys, indexing, constraints
- [[Data Vault & Lakehouse Modelling]] — modern modelling patterns that build on this
