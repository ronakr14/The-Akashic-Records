...
---
# AI Summary
Explains database design from first principles, covering entities, attributes, relationships, keys, normalization, denormalization, constraints, indexing, transactions, ACID properties, OLTP vs OLAP, and a practical database design workflow. Includes an e-commerce example, common beginner mistakes, and guidance on how database design relates to data engineering and data warehousing.
...
- [[Data Modelling]] — conceptual/logical modelling that precedes this
- [[Partitioning]] — physical layout for large tables
- [[UUIDv7 & ULID]] — primary key choice and index fragmentation
- [[Microservices]] — database-per-service ownership
