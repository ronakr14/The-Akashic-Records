...
---
# AI Summary
Guide for interacting more effectively with LLMs by structuring conversations around decision-making instead of information gathering. Covers techniques such as separating exploration from decision mode, stating constraints early, requesting tradeoffs, performing architecture reviews, forcing prioritization, using successive levels of detail, adversarial critique, lightweight decision records, ROI ranking, and phased project planning to improve the quality and actionability of AI-assisted work.
