...
subdomain: delta-lake-optimization
note_type: concept
source_type: self
status: evergreen
level: intermediate
---
# AI Summary
Comprehensive guide to ELT (Extract, Load, Transform) covering its workflow, comparison with ETL, cloud-native motivations, medallion architecture, practical ecommerce example, tooling ecosystem (dbt, Airbyte, Airflow), data quality practices, monitoring, observability, anti-patterns, and decision criteria for choosing ETL, ELT, or hybrid approaches. The note also discusses governance, security, scalability, and operational trade-offs for modern data warehouse and lakehouse architectures.
...
- [[ETL]] — the transform-before-load alternative
- [[ETL vs ELT]] — concise decision reference
- [[Data Vault & Lakehouse Modelling]] — medallion architecture
- [[Data Engineering Playbook]] — where ELT sits among the fundamentals
