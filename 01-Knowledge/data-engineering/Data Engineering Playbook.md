...
---
# AI Summary
Compact playbook covering fifteen foundational principles of data engineering. Topics include batch vs streaming ingestion, CDC, windowing, storage formats, partitioning, ETL vs ELT, workflow orchestration, retries, backfilling, distributed processing, OLTP vs OLAP, CAP theorem, idempotency, and data governance. Serves as a high-level roadmap and interview revision guide linking the core concepts every data engineer should understand
...
14. **Idempotency in Data Pipelines**
...
- [[Batch Processing]] — batch fundamentals
- [[Stream Processing]] — streaming fundamentals
- [[ETL vs ELT]] — ingestion patterns
- [[Partitioning]] — storage and layout
- [[Idempotency in Data Pipelines]] — reliability
