...
---
# AI Summary
Comprehensive reference on modern Data Lake architecture and its evolution into the Lakehouse paradigm. Covers ingestion pipelines, medallion architecture, object storage, governance, metadata catalogs, ACID table formats (Delta Lake, Iceberg, Hudi), comparisons with data warehouses, best practices, technology ecosystem, implementation guidance, and decision frameworks for selecting Data Lake, Warehouse, or Lakehouse architectures in modern data platforms.
...
- [[Delta Lake & Iceberg]] — ACID table formats layered on the lake
