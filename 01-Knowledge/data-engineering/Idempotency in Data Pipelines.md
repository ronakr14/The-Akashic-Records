...
subdomain: pipeline-reliability
note_type: concept
source_type: self
status: curated
level: advanced
---
# AI Summary
Comprehensive guide to idempotency in data engineering. Explains what idempotency is, why it matters for reliable ETL pipelines, its relationship with delivery semantics, common failure modes, implementation techniques such as MERGE, partition overwrite, watermarks, atomic writes, audit tables and deterministic transformations. Covers distributed system patterns including 2PC, Saga and Kafka consumers, along with testing strategies, anti-patterns, and production best practices for building fault-tolerant data pipelines.
...
- [[Failure Recovery in Batch Data Pipelines]] — recovery relies on idempotency
- [[Incremental Data Loading Strategies]] — MERGE and watermark patterns
- [[Batch Processing]] — where idempotency fits in the batch lifecycle
