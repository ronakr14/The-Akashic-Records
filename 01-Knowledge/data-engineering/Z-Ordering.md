...
subdomain: lakehouse-optimization
note_type: concept
source_type: self
status: curated
level: advanced
---
# AI Summary
Comprehensive guide to Z-Ordering in Delta Lake, explaining how it physically reorganizes data to improve file-level data skipping rather than directly accelerating queries. Covers the limitations of partitioning, multi-column bit interleaving, space-filling curves, Parquet statistics, Delta Lake's `OPTIMIZE ... ZORDER BY` command, and how Z-Ordering complements partitioning, Bloom filters, and predicate pushdown. Includes practical examples, architectural guidance for large lakehouses, recommended column selection strategies, anti-patterns, and a mental model for the complete Delta Lake optimization stack.
...
- [[Partitioning]] — the coarser mechanism this complements
- [[Parquet]] — relies on Parquet column statistics
- [[Lakehouse Performance Optimization]] — when to run OPTIMIZE ZORDER
