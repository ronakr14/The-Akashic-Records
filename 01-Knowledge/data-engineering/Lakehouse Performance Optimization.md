...
---
# AI Summary
Practical guide to optimizing lakehouse storage and query performance. Explains optimal file sizing, the impact of small and large files, file compaction strategies, partition pruning mechanics, and techniques for identifying compaction debt. Covers operational symptoms, implementation strategies, optimization thresholds, and best practices for Delta Lake, Iceberg, Hudi, Spark, and other modern lakehouse platforms to improve scan performance and reduce metadata overhead.
...
- [[Partitioning]] — pruning effectiveness
- [[Z-Ordering]] — data skipping via clustering
- [[Parquet]] — small-file problem and compaction
- [[Bloom Filters - Row Group Pruning]] — equality pruning layer
- [[Query Optimization]] — reading plans to find the bottleneck
