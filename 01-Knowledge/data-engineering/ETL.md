...
---
# AI Summary
Comprehensive reference on the ETL (Extract, Transform, Load) pattern, explaining its workflow, historical motivation, advantages, disadvantages, and modern relevance. Uses an ecommerce example to illustrate transformations before loading, includes Python and Apache Airflow implementation examples, discusses compliance and storage considerations, traces the evolution from traditional ETL servers to cloud-native data platforms, provides decision guidelines for choosing ETL versus ELT, and links ETL to orchestration, incremental loading, idempotency, and batch processing concepts.
...
- [[ELT (Extract, Load, Transform)]] — the load-then-transform alternative
- [[ETL vs ELT]] — concise decision reference
- [[Data Engineering Playbook]] — where ETL sits among the fundamentals
