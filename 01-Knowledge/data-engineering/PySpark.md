...
---
# AI Summary
A comprehensive architect-level guide to PySpark that explains it as a distributed computation interface rather than a Python data processing library. The note covers Spark's execution model, Catalyst optimizer, DAG construction, distributed scheduling, ETL pipelines, data lake processing, performance optimization, partitioning, shuffle avoidance, adaptive query execution, ecosystem integrations, architectural trade-offs, and common pitfalls. It also compares PySpark with Pandas, Polars, DuckDB, Dask, Ray, Flink, and Databricks, providing practical guidance on selecting the right tool for distributed data engineering workloads.
...
- [[Polars]] — single-node columnar alternative
- [[Pandas]] — the API PySpark's pandas layer mimics
- [[Partitioning]] — shuffle and partition tuning
- [[Query Optimization]] — Catalyst plans
