...
---
# AI Summary
Practical reference for diagnosing and optimizing analytical queries in distributed data engines. Covers common causes of excessive scans, interpreting execution plans to identify expensive joins, full table scans, data skew, and shuffles, along with optimization strategies. Also outlines features that can be extracted from query plans for building an AI-powered query optimization engine, including structural, cardinality, cost, shuffle, and filter metrics, plus possible ML and rule-based modeling approaches.
...
- [[Partitioning]] — partition pruning in plans
- [[Lakehouse Performance Optimization]] — storage-side fixes for slow scans
- [[Parquet]] — predicate pushdown and statistics
- [[PySpark]] — Catalyst optimizer and plan analysis
