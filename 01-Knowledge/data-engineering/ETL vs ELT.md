...
---
# AI Summary
Concise reference comparing ETL and ELT, explaining their execution order, transformation location, modern cloud adoption, and trade-offs. Covers why ELT dominates cloud-native data platforms, situations where ETL is still preferred, the five conceptual layers of ETL, core engineering topics such as CDC, incremental loading, idempotency, lineage, SLAs, and data quality, and illustrates how ETL integrates with data modeling, orchestration, observability, and modern lakehouse architectures. Includes interview-ready decision guidelines and related concepts.
...
- [[ETL]] — full ETL treatment
- [[ELT (Extract, Load, Transform)]] — full ELT treatment
- [[Data Engineering Playbook]] — broader fundamentals
