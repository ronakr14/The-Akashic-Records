...
---
# AI Summary
A comprehensive guide to data partitioning from first principles through architect-level concepts. The note explains partitioning types, partition pruning, storage versus processing partitions, implementations in PostgreSQL, Delta Lake, DuckDB, and DuckLake, partition key selection, optimization techniques, troubleshooting, predicate pushdown, file compaction, clustering, query plan analysis, and modern lakehouse best practices. It emphasizes how partitioning influences storage design, distributed execution, and query performance across modern analytics platforms.
...
- [[Z-Ordering]] — finer data skipping within partitions
- [[Parquet]] — file-level pruning below partitions
- [[Lakehouse Performance Optimization]] — operational symptoms of bad partitioning
- [[Query Optimization]] — partition pruning in execution plans
- [[Database Design]] — partitioning large OLTP/OLAP tables
