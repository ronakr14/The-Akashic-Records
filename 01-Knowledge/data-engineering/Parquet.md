...
- [[Bloom Filters]] — row-group Bloom filter internals
- [[Z-Ordering]] — data skipping via file layout
- [[Partitioning]] — coarser pruning above the file level
- [[Lakehouse Performance Optimization]] — file sizing and compaction
- [[Polars]] — reads Parquet through Arrow
