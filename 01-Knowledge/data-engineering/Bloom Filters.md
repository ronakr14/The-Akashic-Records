...
---
# AI Summary
Comprehensive reference on Bloom Filters, a memory-efficient probabilistic data structure used for fast membership testing with guaranteed negatives and possible positives. Explains internal hashing mechanics, false-positive mathematics, sizing formulas, implementation in Parquet, Spark, Iceberg, Delta Lake, and distributed databases, along with production monitoring, engine compatibility, operational guidance, code examples, interview questions, and practical recommendations for when Bloom Filters should and should not be used.
...
- [[Parquet]] — where Bloom filters live in row-group metadata
- [[Bloom Filters - Row Group Pruning]] — the ADR that adopts them
- [[Query Optimization]] — equality-filter selectivity problem
