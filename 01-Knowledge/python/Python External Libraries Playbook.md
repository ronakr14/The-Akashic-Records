...
---
# AI Summary
A practical guide to sharing and consuming Python libraries across projects. The note explains editable local installs, path-based dependencies, building and installing wheel packages, installing libraries directly from Git repositories, and using Poetry with `pyproject.toml` for dependency management. It also highlights common packaging pitfalls such as cached wheels, dependency resolution issues, editable install breakage, and lock file synchronization, providing concise recommendations for reliable Python package development and reuse.
...
- [[Python Environment Playbook]] — runtimes and virtualenvs
- [[Python - Modules & Packages]] — package structure
- [[Python Import Path Setup]] — runtime path fix
