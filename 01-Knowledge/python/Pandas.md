...
---
# AI Summary
A comprehensive reference on Pandas covering its mental model, dataframe internals, core use cases, performance characteristics, anti-patterns, alternatives, optimization techniques, algorithms, architectural concepts, ecosystem integration, and engineering trade-offs. The note explains when to use Pandas versus Polars, DuckDB, Spark, and Dask, provides practical performance guidance, and discusses how Pandas fits into modern data engineering, machine learning, LLM evaluation, and analytics workflows, making it a complete technical reference for Python-based data processing.
...
- [[Polars]] — faster columnar alternative
- [[PySpark]] — distributed alternative
- [[Python - Files & Serialization]] — underlying file formats
