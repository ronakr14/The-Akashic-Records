...
---
# AI Summary
A comprehensive guide to secure password storage covering salts, peppers, modern password hashing algorithms, production architectures, and implementation best practices. The note compares Argon2id, bcrypt, scrypt, PBKDF2, and insecure hashing approaches, provides Python examples using argon2-cffi, bcrypt, and Passlib, discusses common implementation mistakes, migration strategies, and interview questions, and explains why memory-hard password hashing is essential for protecting credentials against modern brute-force and GPU-based attacks.
...
- [[FastAPI Authentication]] — where hashed passwords are used
- [[UUIDv7 & ULID]] — other backend fundamentals
- [[Database Design]] — storing credentials safely
