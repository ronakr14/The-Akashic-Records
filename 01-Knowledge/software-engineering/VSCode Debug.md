...
---
# AI Summary
Practical guide to debugging Python applications in Visual Studio Code. Demonstrates setting and using breakpoints, conditional breakpoints, logpoints, custom `launch.json` configurations, and attaching the debugger to an already running Python process with `debugpy`. Includes step-by-step examples for inspecting variables, debugging applications with command-line arguments, and remote debugging workflows without modifying application code.
...
- [[Python - Concurrency]] — debugging async and threaded code
- [[Python Environment Playbook]] — matching the interpreter in launch.json
- [[Compare File in Powershell]] — other local dev tooling
