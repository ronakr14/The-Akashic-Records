...
---
# AI Summary
Comprehensive guide to UUIDv7 and ULID as sortable, distributed identifier formats that overcome UUIDv4 index fragmentation. Explains their binary layouts, comparison with UUIDv4, Snowflake, and auto-increment IDs, database implications, implementation examples in Python, Java, Go, SQL, and database-specific recommendations for PostgreSQL, MySQL, Snowflake, and Redshift. Covers failure modes such as clock drift, migration strategies from UUIDv4 and auto-increment keys, and common anti-patterns for designing scalable, index-friendly primary keys in distributed systems.
...
- [[Database Design]] — primary key selection
- [[Partitioning]] — index fragmentation and key ordering
- [[Password Storage]] — other backend fundamentals
