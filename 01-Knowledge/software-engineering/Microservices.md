...
---
# AI Summary
A comprehensive guide to microservices covering their mental model, core principles, architecture, communication patterns, service discovery, API gateways, fault tolerance, distributed transactions with the Saga pattern, observability, deployment strategies, advantages, disadvantages, and when to avoid microservices. The note also maps the surrounding technology ecosystem and emphasizes that microservices are fundamentally an application of distributed systems, making it a strong conceptual reference for software architecture and system design interviews
...
| **Service Mesh** | Istio Architecture Deep Dive, Linkerd |

## Related

- [[Monolithic System]] — the architecture it is usually compared against
- [[Distributed System]] — the systems concepts it inherits
- [[Database Design]] — database-per-service ownership
- [[Stream Processing]] — event-driven communication
- [[FastAPI Authentication]] — securing service endpoints
- [[_Software Engineering MOC]] — domain index
