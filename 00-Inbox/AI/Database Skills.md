...
---
# AI Summary
Analysis of PlanetScale's Database Skills repository, which provides database-specific AI skills for MySQL, PostgreSQL, Vitess, and Neki. Explains its architecture, workflow, supported databases, integrations, use cases, strengths, limitations, and how specialized AI skills improve database design, query tuning, migrations, and operational guidance compared to generic prompting. 
