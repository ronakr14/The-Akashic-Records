# AI Summary
OpenSpec is an open-source Spec-Driven Development (SDD) framework that introduces a structured specification layer between developers and AI coding assistants. It manages proposals, specifications, designs, and implementation tasks as repository-native artifacts to improve traceability, governance, and consistency in AI-assisted software development. The note analyzes its architecture, workflow engine, CLI, agent integrations, engineering trade-offs, enterprise readiness, and applications across software, platform, AI, and data engineering, making it a comprehensive reference for specification-driven engineering and AI governance.
...
- [[BitRouter]] — another AI coding tool in the same ecosystem
