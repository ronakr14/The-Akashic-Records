...
| I want to… | Use this |
|---|---|
| Tailor my resume to a JD | [[Career/Resume — Optimization]] |
| Get my CV past ATS filters | [[Career/ATS — Hard Mode]] |
| Write a cover letter | [[Career/Cover Letter]] |
| Prep for an interview loop | [[Career/Interview — Prep]] |
| Audit / rewrite my LinkedIn | [[Career/LinkedIn — Profile Audit]] |
| Rewrite my GitHub profile README | [[GitHub/Profile — README Rewrite]] |
| Deep-analyze a repo before adopting it | [[GitHub/Repo — Deep Analysis]] |
| Decide whether a tool is worth 30 sec of my time | [[Tools/Quick Summary]] |
| Get a deep architectural breakdown of a tool | [[Tools/Deep Dive]] |
| Wrap a session with full handoff | [[Session/End of Session — Handoff]] |
| Update today's daily note from a session | [[Session/Daily Note — Update]] |
| Extract session corrections into a feedback.md | [[Session/Feedback — Extract]] |
