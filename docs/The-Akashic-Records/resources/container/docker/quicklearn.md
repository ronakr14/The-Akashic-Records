...
[#tag.resources.docker.quicknotes](/tags/tag/resources/docker/quicknotes.md)
...
- `FROM`, `WORKDIR`, `COPY`, `RUN`, `CMD` – the _Dockerfile DNA_
...
- `Dockerfile`
- `docker-compose.yml` _(once you’re ready)_
- `.dockerignore` _(like `.gitignore`, but for containers)_
