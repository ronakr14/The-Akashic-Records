...
This is one of the most important data engineering concepts because batch jobs **will fail**, **will be retried**, and **will be backfilled**. If rerunning a job changes the result, you have a serious reliability problem.
